...
export const signIn = createAsyncThunk<signData, UserAPI.SigninForm, { rejectValue: string }>("core/signIn", async function (data, thunkAPI) {
  try {
...
export const signUp = createAsyncThunk<signData, UserAPI.SignupForm, { rejectValue: string }>("core/signUp", async function (data, thunkAPI) {
  try {
...
export const getMe = createAsyncThunk<IUser>("core/getMyData", async function (_, thunkAPI) {
  try {
